...
/**
 * Esta clase se creo para persistir los tipos de conceptos en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public final class EntidadTipoConcepto extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoConcepto(int id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoConcepto(int id, String descripcion, String fechaDesde, String fechaHasta) {
        this.id = id;
        this.descripcion = descripcion;
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoConcepto objActual = (EntidadTipoConcepto) objeto;
