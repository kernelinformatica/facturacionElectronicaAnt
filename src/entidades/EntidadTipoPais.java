...
/**
 * Esta clase se creo para persistir los tipos de paises en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public class EntidadTipoPais extends Entidad {
     ...
     * @param descripcion
     */
    public EntidadTipoPais(int id, String descripcion) {
        this.id = id;
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoPais objActual = (EntidadTipoPais) objeto;
