...
/**
 * Esta clase se creo para persistir los tipos de moenda en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public final class EntidadTipoMoneda extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoMoneda(String id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoMoneda(String id, String descripcion, String fechaDesde, String fechaHasta) {
        this.id = id;
        this.descripcion = descripcion;
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoMoneda objActual = (EntidadTipoMoneda) objeto;
