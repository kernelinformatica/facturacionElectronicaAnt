...
/**
 * Esta clase se creo para persistir los tipos de comprobantes en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public final class EntidadTipoComprobante extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoComprobante(int id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoComprobante(int id, String descripcion, String fechaDesde, String fechaHasta){
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoComprobante objActual = (EntidadTipoComprobante) objeto;
