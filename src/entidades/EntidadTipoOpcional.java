 ...
 */
public final class EntidadTipoOpcional extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoOpcional(String id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoOpcional(String id, String descripcion, String fechaDesde, String fechaHasta) {
        this.id = id;
        this.descripcion = descripcion;
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoOpcional objActual = (EntidadTipoOpcional) objeto;
