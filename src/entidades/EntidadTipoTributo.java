...
/**
 * Esta clase se creo para persistir los tipos de tributos en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public final class EntidadTipoTributo extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoTributo(int id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoTributo(int id, String descripcion, String fechaDesde, String fechaHasta) {
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoTributo objActual = (EntidadTipoTributo) objeto;
