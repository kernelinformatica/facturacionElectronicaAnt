...
/**
 * Esta clase se creo para persistir los tipos de IVA en la base de datos
 * Sybase
 *
 * @author Matias Panasci Alias Panic
 */
public final class EntidadTipoIVA extends Entidad {
     ...
     * @param fechaHasta 
     */
    public EntidadTipoIVA(int id, String descripcion, Date fechaDesde, Date fechaHasta) {
        this.id = id;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoIVA(int id, String descripcion, String fechaDesde, String fechaHasta) {
        this.id = id;
        this.descripcion = descripcion;
     ...
     * @param fechaHasta 
     */
    public EntidadTipoIVA(String id, String descripcion, String fechaDesde, String fechaHasta) {
    ...
    public boolean comparar(Entidad objeto) {
        ...
        EntidadTipoIVA objActual = (EntidadTipoIVA) objeto;
