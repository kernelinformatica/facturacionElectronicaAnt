...
import entidades.EntidadTipoMoneda;
 ...
 */
public class ControladorTiposMonedas extends ConexionSyBase implements IPersistencia  {

    private final static Logger log = Logger.getLogger(ControladorTiposMonedas.class);
     ...
     * @throws Exception 
     */
    public ControladorTiposMonedas() throws Exception {
    ...
    public int vaciarTabla() throws Exception {
        ...
        String instruccionSQL = "DELETE FROM afipws_fe_TiposMoneda";
    ...
    public int insertar(Entidad objeto) throws Exception {
        ...
        // Armo la instruccion SQL
        String instruccionSQL = "INSERT INTO afipws_fe_TiposMoneda VALUES (?,?,?,?)";
        
        // Instancio el objeto que me permite ejecutar la instruccion
        PreparedStatement sentencia = crearSentencia(instruccionSQL);
        
        // Casteo el objeto como entidad
        EntidadTipoMoneda entidad = (EntidadTipoMoneda)objeto;
     ...
     * 
     * @param listaTiposMonedas 
     * @throws java.lang.Exception 
     */
    @Override
    public void guardarDatos(List listaTiposMonedas) throws Exception{
        
        // Recorro la lista recibida como parametro
        for (Iterator it = listaTiposMonedas.iterator(); it.hasNext();) {
            
            wsAFIP.Moneda obj = (wsAFIP.Moneda) it.next();
            
            // Obtengo un elemento de la lista
            EntidadTipoMoneda mon = new EntidadTipoMoneda(obj.getId(),
                                                          obj.getDesc(),
                                                          obj.getFchDesde(),
                                                          obj.getFchHasta());
