...
import entidades.EntidadTipoDocs;
 ...
 */
public class ControladorTiposDocumentos extends ConexionSyBase implements IPersistencia  {

    private final static Logger log = Logger.getLogger(ControladorTiposDocumentos.class);
     ...
     * @throws Exception 
     */
    public ControladorTiposDocumentos() throws Exception {
    ...
    public int vaciarTabla() throws Exception {
        ...
        String instruccionSQL = "DELETE FROM afipws_fe_TiposDocs";
    ...
    public int insertar(Entidad objeto) throws Exception {
        ...
        // Armo la instruccion SQL
        String instruccionSQL = "INSERT INTO afipws_fe_TiposDocs VALUES (?,?,?,?)";
        
        // Instancio el objeto que me permite ejecutar la instruccion
        PreparedStatement sentencia = crearSentencia(instruccionSQL);

        // Casteo el objeto como entidad
        EntidadTipoDocs entidad = (EntidadTipoDocs)objeto;
     ...
     */
    @Override
    public void guardarDatos(List listaTipoDocs) throws Exception{
        
        // Recorro la lista recibida como parametro
        for (Iterator it = listaTipoDocs.iterator(); it.hasNext();) {
            
            wsAFIP.DocTipo obj = (wsAFIP.DocTipo) it.next();
            
            // Obtengo un elemento de la lista
            EntidadTipoDocs tc = new EntidadTipoDocs(obj.getId(), 
                                                    obj.getDesc(), 
                                                    obj.getFchDesde(), 
                                                    obj.getFchHasta());
