...
import entidades.EntidadTipoTributo;
 ...
 */
public class ControladorTiposTributos extends ConexionSyBase implements IPersistencia  {

    private final static Logger log = Logger.getLogger(ControladorTiposTributos.class);
     ...
     * @throws Exception 
     */
    public ControladorTiposTributos() throws Exception {
    ...
    public int vaciarTabla() throws Exception {
        ...
        String instruccionSQL = "DELETE FROM afipws_fe_TiposTributos";
    ...
    public int insertar(Entidad objeto) throws Exception {
        ...
        // Armo la instruccion SQL
        String instruccionSQL = "INSERT INTO afipws_fe_TiposTributos VALUES (?,?,?,?)";
        
        // Instancio el objeto que me permite ejecutar la instruccion
        PreparedStatement sentencia = crearSentencia(instruccionSQL);
        
        // Casteo el objeto como entidad
        EntidadTipoTributo entidad = (EntidadTipoTributo)objeto;
    ...
    public void guardarDatos(List listaTipoTributos) throws Exception{
        ...
        for (Iterator it = listaTipoTributos.iterator(); it.hasNext();) {
            ...
            wsAFIP.TributoTipo obj = (wsAFIP.TributoTipo) it.next();
            
            // Obtengo un elemento de la lista
            EntidadTipoTributo tipoTrib = new EntidadTipoTributo(obj.getId(),
                                                    obj.getDesc(),
                                                    obj.getFchDesde(),
                                                    obj.getFchHasta());
            
            // Lo guardo en la base de datos
            this.insertar(tipoTrib);
        }
    }
