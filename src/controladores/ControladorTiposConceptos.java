...
import entidades.EntidadTipoConcepto;
import entidades.Entidad;
import org.apache.log4j.Logger;
import org.apache.log4j.PropertyConfigurator;

/**
 * Esta clase se creo para implementar la persistencia de los tipos de conceptos
 * 
 * @author Matias Panasci Alias Panic
 */
public class ControladorTiposConceptos extends ConexionSyBase implements IPersistencia  {

    private final static Logger log = Logger.getLogger(ControladorTiposConceptos.class);
     ...
     * @throws Exception 
     */
    public ControladorTiposConceptos() throws Exception {
    ...
    public int vaciarTabla() throws Exception {
        ...
        String instruccionSQL = "DELETE FROM afipws_fe_TiposConceptos";
    ...
    public int insertar(Entidad objeto) throws Exception {
        ...
        // Armo la instruccion SQL
        String instruccionSQL = "INSERT INTO afipws_fe_TiposConceptos VALUES (?,?,?,?)";
        
        // Instancio el objeto que me permite ejecutar la instruccion
        PreparedStatement sentencia = crearSentencia(instruccionSQL);
        
        // Casteo el objeto como entidad
        EntidadTipoConcepto entidad = (EntidadTipoConcepto)objeto;
     ...
     * 
     * @param listaTiposConcepto 
     * @throws java.lang.Exception 
     */
    @Override
    public void guardarDatos(List listaTiposConcepto) throws Exception{
        
        // Recorro la lista recibida como parametro
        for (Iterator it = listaTiposConcepto.iterator(); it.hasNext();) {
            
            wsAFIP.ConceptoTipo obj = (wsAFIP.ConceptoTipo) it.next();
            
            // Obtengo un elemento de la lista
            EntidadTipoConcepto tc = new EntidadTipoConcepto(obj.getId(), 
                                                            obj.getDesc(), 
                                                            obj.getFchDesde(), 
                                                            obj.getFchHasta());
